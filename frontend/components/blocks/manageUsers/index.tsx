                            ...
                            <div className="manage-users-card-table">
                                <div className='manage-users-card-name-image'>
                                    {user.role === "admin" ? (
                                        ...
                                        <Image src={'/editor.png'} alt="user avatar" width={50} height={50} className='manage-users-card-image' />
                                    ) : (
                                        <Image src={'/working.png'} alt="user avatar" width={50} height={50} className='manage-users-card-image' />
                                    )}
                                ...
                                >
                                    <div className="create-user-form-container">
                                        ...
                                        <form onSubmit={handleSubmit(onSubmit)} className='create-user-form'>
                                            ...
                                            <div className="create-user-form-item">
                                                <label className="create-user-form-label">Role: </label>
                                                <Controller
                                                    name="role"
                                                    control={control}
                                                    rules={{
                                                    ...
                                                    render={({ field }: { field: SelectOptionProps }) => (
                                                        <select {...field} className="create-user-form-input-select">
